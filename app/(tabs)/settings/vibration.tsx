                ...
                <ScrollView style={{flex: 1, gap: 16, padding: 16, backgroundColor: '#EBEBEB'}}>
                    <View className="flex gap-4">
                        <View className="flex-1 flex-row items-center justify-between">
                            ...
                            <View>
                                <Text className="text-gray-600 text-lg font-semibold">Vibration</Text>
                            </View>
                            <View>
                        ...
                        <View
                            ...
                            <View>
                                <Text
                                    className="text-base font-semibold text-gray-700">{isVibration ? "On" : "Off"}</Text>
                            </View>
                            <CustomSwitch isEnabled={isVibration} setIsEnabled={setIsVibration}/>
                        </View>

                        <View className="p-2 flex gap-2">
                            <Text className="text-base font-semibold text-gray-700">About Vibration</Text>
