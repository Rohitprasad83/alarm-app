...
export default function DoNotDisturb() {
    ...
    const [isDoNotDisturb, setIsDoNotDisturb] = useState(true);
    const [isCalmerNights, setIsCalmerNights] = useState(true);
                ...
                <ScrollView style={{flex: 1, gap: 16, padding: 16, backgroundColor: '#EBEBEB'}}>
                    <View className="flex gap-8">
                        <View className="flex-1 flex-row items-center justify-between">
                            ...
                            <View>
                                <Text className="text-gray-600 text-lg font-semibold">Do Not Disturb</Text>
                            </View>
                            <View>
                        ...
                        <View className="gap-2 mt-4">
                            <View
                                ...
                                <View className="flex-1 gap-2">
                                    <Text className="text-base font-semibold text-gray-700">Bypass Do not disturb</Text>
                                    <Text className="text-sm font-normal text-gray-500 text-wrap">This will
                                        automatically stop the white noise from playing after the specific
                                        amount of time you set.</Text>
                                </View>
                                <View className="flex w-max">
                                    <CustomSwitch isEnabled={isDoNotDisturb} setIsEnabled={setIsDoNotDisturb}/>
                                </View>
                            </View>
                            ...
                            <View
                                className="flex flex-row items-center justify-between bg-gray-100 rounded-3xl p-4 gap-4">
                                <View className="flex-1 gap-2">
                                    <Text className="text-base font-semibold text-gray-700">Calmer Nights</Text>
                                    <Text className="text-sm font-normal text-gray-500 text-wrap">This will
                                        automatically stop the white noise from playing after the specific amount of
                                        time you set.</Text>
                                </View>
                                <View className="flex w-max">
                                    <CustomSwitch isEnabled={isCalmerNights} setIsEnabled={setIsCalmerNights}/>
                                </View>
                            </View>
                        </View>
                    </View>
